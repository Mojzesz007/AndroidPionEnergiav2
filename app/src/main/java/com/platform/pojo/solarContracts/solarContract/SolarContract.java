...
public class SolarContract {
    ...
    @Expose
    private Double moduleTotalPower;
    ...
    public Double getModuleQuantity() {
        return moduleQuantity;
    }

    public void setModuleQuantity(Double moduleQuantity) {
        this.moduleQuantity = moduleQuantity;
    }

    public Double getModuleTotalPower() {
        return moduleTotalPower;
    }

    public void setModuleTotalPower(Double moduleTotalPower) {
    ...
    public String getMethodOfInstallation() {
        return methodOfInstallation;
    }

    public void setMethodOfInstallation(String methodOfInstallation) {
    ...
    public String getEarthResistanceMeasurementResult() {
        return earthResistanceMeasurementResult;
    }

    public void setEarthResistanceMeasurementResult(String earthResistanceMeasurementResult) {
    ...
    public Object getOtherProvisions() {
        return otherProvisions;
    }

    public void setOtherProvisions(Object otherProvisions) {
